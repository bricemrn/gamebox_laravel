<div class="admin-sidebar">
    <div class="sidebar-intro">
        <img class="sidebar-img" src="<?php echo e(url('')); ?>/public/assets/images/admin/gandalf2.jpg" alt="">
        <h6><?php echo e(Auth::user()->name); ?></h6>
        <li>
            <a class="admin-logout" href="<?php echo e(route('logout')); ?>"
...
<?php $__env->stopPush(); ?><?php /**PATH /home/clients/94e6ac6d287e346ebaeea29a3b71eb72/sites/gamebox.wewantdev.fr/gamebox/resources/views/admin/admin_sidebar.blade.php ENDPATH**/ ?>