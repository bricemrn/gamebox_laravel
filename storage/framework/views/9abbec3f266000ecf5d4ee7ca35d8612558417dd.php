    ...
    <nav>
        ...
        <ul class="nav-links">
            ...
            <div class="nav-login">
                ...
                <?php else: ?>
                    <div>
                        <a href="<?php echo e(route('profile', [Auth::user()->id])); ?>" id="profile"><img src="<?php echo e(url('')); ?>/public/<?php echo e(Auth::user()->avatar); ?>" alt="" class="nav-profile-img"><?php echo e(Auth::user()->name); ?></a>
                    </div>
                    <div>
...
<?php /**PATH /home/clients/94e6ac6d287e346ebaeea29a3b71eb72/sites/gamebox.wewantdev.fr/gamebox/resources/views/partials/_header.blade.php ENDPATH**/ ?>