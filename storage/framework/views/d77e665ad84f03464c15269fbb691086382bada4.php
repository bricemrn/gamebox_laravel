    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel" data-intervale="2000">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item item <?php echo e($loop->first ? ' active' : ''); ?>">
                <img class="d-block w-100" src="<?php echo e(url('')); ?>/<?php echo e($new->image); ?>" alt="First slide">
            ...
            <div class="news-card">
                <div class="news-card-header">
                    <a href="<?php echo e(route('newsdetails', [$new->slug])); ?>">
                        <img src="<?php echo e(url('')); ?>/<?php echo e($new->image); ?>" alt="">
                    </a>
                </div>
...
<?php echo $__env->make('partials._main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\bricedev\gamebox_prod\resources\views/news.blade.php ENDPATH**/ ?>