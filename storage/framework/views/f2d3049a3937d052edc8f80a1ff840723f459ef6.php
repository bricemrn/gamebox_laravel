        ...
        <table class="table table-striped" id="adminUserDataTable">
            ...
            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <th><?php echo e(\Illuminate\Support\Str::limit($user->password, $limit = 20, $end = ' ...')); ?></th>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <?php echo e(csrf_field()); ?>
                            ...
                            <p>Êtes-vous de vouloir supprimer cet utilisateur ?</p>
...
<?php echo $__env->make('partials._admin_main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\bricedev\gamebox\resources\views/admin/admin_users.blade.php ENDPATH**/ ?>